    ...
    <div class="container">
        <div class=" col-lg-4 col-lg-offset-3">
            <div class="page-header">
                <h1 class="col-lg-offset-3">Upload Video</h1>
            </div>
            ...
            <form class="" action="/upload/video" method="post" enctype="multipart/form-data">
                {{method_field('PATCH')}}
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <input class="form-control" placeholder="Enter Link " value="{{old('relationship')}}" type="text"
                                   name="link" id="phone"  required/>
                        </div>
                    </div>
                </div>
