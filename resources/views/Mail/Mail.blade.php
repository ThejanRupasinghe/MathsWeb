					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav class="menu menu--shylock">
							...
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="Mail.blade.php">Mail Us</a></li>
							</ul>
						</nav>
					</div>
				</nav>	
		...
		<div class="container">
			...
			<div class="col-md-2 w3l_footer_grid">
				...
				<ul class="agileinfo_footer_grid_nav">
					...
					<li><a href="Mail.blade.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>Mail Us</a></li>
				</ul>
			</div>
			<div class="col-md-3 w3l_footer_grid">
				<h3>Social Media</h3>
